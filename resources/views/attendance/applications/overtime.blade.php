...
@section('title', 'HRIS - Overtime Requests')
@section("content")
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Overtime Requests</h4>
                ...
                <div class="col-lg-12">
                    @if(Auth()->user()->company->policies->enable_overtime === 0)
                    <div class="card">
                        <div class="card-body text-center bg-light">
                            <span class="text-warning">Overtime Requests are currently turned off. To allow requests, check the company policies.</span>
                        </div>
                    </div>
                    @endif
                    <div class="card">
                                ...
                                <table class="table align-middle table-nowrap table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('attendance.applications.view_overtime', ['id' => $req->ot_req_id])}}"><i class="mdi mdi-eye font-size-22 my-auto text-dark"></i></a>
                                            </td>
                                        </tr>
                                        @empty
                                        @endforelse
